...
```sh dir=../../examples/code/sexpr/read_foo,non-deterministic=command
...
Raised at file "sexp_conv.ml", line 194, characters 30-72
...
```sh dir=../../examples/code/sexpr/read_foo_better_errors,non-deterministic=command
...
Raised at file "src/pre_sexp.ml", line 742, characters 4-56
