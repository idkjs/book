...
```sh dir=../../examples/code/command-line-parsing/md5_multiarg,skip
$ dune build md5.exe
...
```sh dir=../../examples/code/command-line-parsing/md5_with_custom_arg,skip
$ dune build md5.exe
...
```sh dir=../../examples/code/command-line-parsing/md5_with_optional_file,skip
$ dune build md5.exe
...
```sh dir=../../examples/code/command-line-parsing/md5_with_default_file,skip
$ dune build md5.exe
$ cat /etc/services | ./_build/default/md5.exe
27bf1f2dbadd4cae84f1da4dfe8b5cb3
```
...
```sh dir=../../examples/code/command-line-parsing/md5_sequence,skip
$ dune build md5.exe
